...
class Settings extends PrivateController
{
    ...
    private function settings_validation_type(): array
    {
        return [
            ...
            "stripe_publish_key" => ["label" => lang("Fields.field_92"),  "rules" => "required|min_length[8]|max_length[100]"],
            "stripe_secret_key"  => ["label" => lang("Fields.field_93"),  "rules" => "required|min_length[8]|max_length[100]"],
